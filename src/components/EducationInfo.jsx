export default function EducationInfo() {
    ...
    return (
        <>
            ...
            <input className="col-4 ml-2" type="text" name="university" id="university"/><br/>
            ...
            <input className="col-3 ml-2" type="date" id="startDate" name="uniStartDate"/><br/>
            <label htmlFor="endDate">End Date:</label>
            <input className="col-3 ml-2" type="date" id="endDate" name="uniEndDate"/><br/>
        </>
